...
namespace tessefakt\apps\hebaz\libraries\midwives\cds;
...
class states extends \tessefakt\library
{
	...
	protected function _create(
		...
		$this->connectors->db->query('
			insert into `midwives-cds-states`
			set
				`midwife-cd`=' . $midwife_cd . ',
