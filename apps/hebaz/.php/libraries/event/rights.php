...
class rights extends \tessefakt\library{
	...
	protected function _create(int $event,int|null $_group,int|null $_user,int|string|null $from,int|string|null $till,string|null $internal_remark,bool|int|null $right_create,bool|int|null $right_read,bool|int|null $right_update,bool|int|null $right_delete):int{
		$this->connectors->db->query('
			insert into `event-rights`
			set
				`event`='.$event.',
