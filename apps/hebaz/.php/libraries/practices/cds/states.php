...
namespace tessefakt\apps\hebaz\libraries\practices\cds;
...
class states extends \tessefakt\library
{
	...
	protected function _create(
		...
		$this->connectors->db->query('
			insert into `practices-cds-states`
			set
				`practice-cd`=' . $practice_cd . ',
